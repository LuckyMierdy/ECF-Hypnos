 ...
 */
final class Version20220416191126 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE room ADD CONSTRAINT FK_729F519BEC98DB74 FOREIGN KEY (hotel_relation_id) REFERENCES hotel (id)');
